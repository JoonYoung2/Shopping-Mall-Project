		...
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5 align-items-center">
				<div class="col-md-9">
					<div class="container px-4 px-lg-5 my-5">
						<div class="row gx-4 gx-lg-5 align-items-center">
							<div class="col-md-4" style="width:100%;">
								...
								<div class="fs-6 mb-1">${user.user_nm } ${user.user_phoneNum }</div>
								<div class="fs-6 mb-1">${user.address_info } ${user.address_detail }</div>
								<hr class="mb-3" style="margin: 30px 0 8px;">
					...
					<c:forEach var="prdts" items="${prdt }">
						...
						<hr class="mb-3" style="margin: 16px 0 8px;">
							...
							<div class="col-md-4 mb-3" style="width:100%;">
								...
								<input type="radio" name="xxx" value="yyy" checked><span style="padding-left:10px;">카카오페이</span>
							</div>
					...
					<div class="fs-7 mb-0"
						style="display: flex; justify-content: space-between;">상품 금액</div>
					<c:forEach var="prdts" items="${prdt }">
						<div class="fs-7 mb-0"
