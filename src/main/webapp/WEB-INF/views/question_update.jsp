		...
		<section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">수정하기</h2>
                    <h3 class="section-subheading text-muted">수정할 내용을 입력해주세요!</h3>
                ...
                <div class="row">
                   	 <form action="question_update" method="post">
                            ...
                            <div class="form-group form-group-textarea mb-md-0">
                                <!-- Message input-->
                                <textarea class="form-control" id="message" name="question" placeholder="Your Question?" data-sb-validations="required" style="text-align:center;"><%=question %></textarea><br><br>
                                <textarea class="form-control" id="message" name="answer" placeholder="Best answer" data-sb-validations="required" style="text-align:center;"><%=answer %></textarea>
