						...
						<div class="col-lg-4 col-sm-6 mb-4">
							<div class="input-form-backgroud row">
								<div class="input-form col-md-12 mx-auto">
									...
									<form class="validation-form" novalidate action="/qna_delete"
										method="post">
										<div class="row">
											<input type="hidden" name="sessionId"
												value="${sessionScope.user_id }" />
											<input type="hidden" name="qna_num" value="${data }" />
										...
										<button class="btn btn-secondary btn-lg btn-block"
											style="width: 49%;" type="submit">삭제하기</button>
							...
							<div class="input-form-backgroud row">
								<div class="input-form col-md-12 mx-auto">
									<a class="btn btn-secondary btn-lg btn-block" style="width:49%;"
										href="kakao_qna_delete?qna_num=${data }">
										삭제하기 </a> <a class="btn btn-secondary btn-lg btn-block"
