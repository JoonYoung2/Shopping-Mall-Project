...
<body>
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										<label for="name">아이디</label> <input type="text"
											class="form-control" name="user_id" placeholder="" value=""
											oninput="test(this.value)">
									</div>
									<div class="col-md-6 mb-3">
										<label for="name">비밀번호</label> <input type="password"
											class="form-control" name="user_pw" value="" required>
									</div>
								</div>
								<hr class="mb-4">
								<div class="mb-4"></div>
								<button class="btn btn-primary btn-lg btn-block" type="submit">탈퇴
									하기</button>
								<a class="btn btn-primary btn-lg btn-block"
									onclick="window.history.back()">뒤로가기</a>
							</form>
						</div>
	...
	<c:if
		test="${sessionScope.loginType eq 2}">
		<section class="page-section bg-light" id="register">
			<div class="container">
				<div class="text-center">
					<h2 class="section-heading text-uppercase">개인정보</h2>
				...
				<div class="container">
					...
					<div class="input-form-backgroud row">
						<div class="input-form col-md-12 mx-auto">
							<h4 class="mb-3">탈퇴하기</h4>
							<a class="btn btn-primary btn-lg btn-block" href="https://kauth.kakao.com/oauth/logout?client_id=8558b06f798d38a90a338f54282456f2&logout_redirect_uri=http://127.0.0.1:8080/kakao_infoDelete">
							탈퇴하기
							</a>
								<a class="btn btn-primary btn-lg btn-block"
									onclick="window.history.back()">뒤로가기</a>
