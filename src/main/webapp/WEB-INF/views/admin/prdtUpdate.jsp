		...
		<table style="width: 650px; ">
			<tr> 
				...
				<td style="width: 570px; height:40px;">
					<input type=text name='prdt_title' value="${datas.prdt_title }"/> 
				</td>
			</tr>
			<tr>
				<td style="width: 80px; height:40px;" align="right">상품명</td>
				<td style="width: 570px; height:40px;">
					<input type=text name='prdt_nm' value="${datas.prdt_nm }"/> 
				</td>
			</tr>
			<tr>
				<td style="width: 80px; height:40px;" align="right">상품 가격</td>
				<td style="width: 570px; height:40px;">
					<input type=text name='prdt_price' value="${datas.prdt_price }"/> 
				</td>
			</tr>
			<tr> 
				<td style="width: 80px; height:40px;" align="right">색 상</td>
				<td style="width: 570px; height:40px;">
					<input type=text name='prdt_color' value="${datas.prdt_color }"/> 
				</td>
			</tr>
			<tr> 
				<td style="width: 80px; height:40px;" align="right">상품 분류</td>
				<td style="width: 570px; height:40px;">
					<input type=text name='prdt_list' value="${datas.prdt_list }"/> 
				</td>
			</tr>
			<tr>
				<td colspan=2 align="right">
				<textarea style="width: 650px; height: 300px" name="prdt_info">${datas.prdt_info }</textarea></td>
			</tr>
			<tr>
